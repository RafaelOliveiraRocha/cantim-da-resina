...
// Mudar Aqui o e-mail
$email_envio = "contato@cantimdaresina.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "#resinadocantim"; // Senha do e-mail

$site_name = "Cantim da Resina"; // Nome do Site
$site_url = "www.cantimdaresina.com"; // URL do Site

$host_smtp = "smtp.cantimdaresina.com"; // HOST SMTP Ex: smtp.domain.com.br
